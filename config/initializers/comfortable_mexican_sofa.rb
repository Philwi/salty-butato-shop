...
ComfortableMexicanSofa::AccessControl::AdminAuthentication.username = Rails.application.credentials.dig(:cms, :username) || "username"
ComfortableMexicanSofa::AccessControl::AdminAuthentication.password = Rails.application.credentials.dig(:cms, :password) || "password"
